...
class holol_flickr_photos extends WP_Widget {
	...
	function holol_flickr_photos() {
		...
		parent::__construct( 'flickr_photos-widget', __( 'flickr' , 'kidz') , $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array( 'title' =>__( 'Flickr' , 'kidz'), 'no_of_photos' => '8' , 'flickr_display' => 'latest' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'flickr_id' ); ?>"><?php _e( 'Flickr ID:' , 'kidz') ?></label>
			...
			<small><?php _e( 'Find Your ID at' , 'kidz') ?> (<a href="http://www.idgettr.com">idGettr</a>)</small>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'no_of_photos' ); ?>"><?php _e( 'Number of photos to show:' , 'kidz') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'flickr_display' ); ?>"><?php _e( 'Photos Order:' , 'kidz') ?></label>
			<select id="<?php echo $this->get_field_id( 'flickr_display' ); ?>" name="<?php echo $this->get_field_name( 'flickr_display' ); ?>" >
				<option value="latest" <?php if( !empty($instance['flickr_display']) && $instance['flickr_display'] == 'latest' ) echo "selected=\"selected\""; else echo ""; ?>><?php _e( 'Most recent' , 'kidz') ?></option>
				<option value="random" <?php if( !empty($instance['flickr_display']) && $instance['flickr_display'] == 'random' ) echo "selected=\"selected\""; else echo ""; ?>><?php _e( 'Random' , 'kidz') ?></option>
			</select>
		</p>
