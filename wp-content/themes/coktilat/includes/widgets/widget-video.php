...
class holol_video_widget extends WP_Widget {
	...
	function holol_video_widget() {
		...
		parent::__construct( 'video-widget', __( 'Video' , 'kidz') , $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array( 'title' =>__('Featured Video', 'kidz') );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'embed_code' ); ?>"><?php _e( 'Embed Code' , 'kidz') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'video_url' ); ?>"><?php _e( 'Video URL' , 'kidz') ?></label>
