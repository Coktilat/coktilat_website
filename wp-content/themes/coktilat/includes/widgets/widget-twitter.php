...
class holol_Latest_Tweets extends WP_Widget {
	...
	function holol_Latest_Tweets() {
		...
		parent::__construct( 'latest_tweets_widget', __( 'Twitter' , 'kidz') , $widget_ops, $control_ops );
	}
...
<?php			}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' =>__('@Follow Me' , 'kidz') , 'no_of_tweets' => '5' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php _e( 'Twitter Username:' , 'kidz') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'consumer_key' ); ?>"><?php _e( 'Consumer key:' , 'kidz') ?> </label>
			...
			<label for="<?php echo $this->get_field_id( 'consumer_secret' ); ?>"><?php _e( 'Consumer secret:' , 'kidz') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'no_of_tweets' ); ?>"><?php _e( 'Number of Tweets to show:' , 'kidz') ?></label>
